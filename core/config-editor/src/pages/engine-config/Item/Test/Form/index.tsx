import { MatchLockEngineConfig, validatePathVariableValue } from "@match-lock/shared";
...
export function valueIsReady(value: TestFormValue, engineConfig: MatchLockEngineConfig){

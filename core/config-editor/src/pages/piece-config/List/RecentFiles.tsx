...
import { RECENT_ROSTER_FILES_KEY } from "../constants";
...
export function RecentFiles(
  ...
  const {
    ...
    removeRecentFile,
    clearRecentFiles,
  } = useRecentFiles(RECENT_ROSTER_FILES_KEY);
        ...
        {displayFiles.map((file, index) => (
          ...
          >
            <div className="file-info">
              <Link to={
                replaceParams(RosterConfigPaths.edit, { rosterPath: encodeURIComponent(file.path) })
              } >

...
These are mandatory, uneditable parts to the piece. Each version is based on the hash of the files that make up that part of the piece.

- Logic - The logic version decides what the piece does in game. Changing files such as speed, health or hitboxes are expected to change the logic version. Changing any logic related file makes the game piece considered a completely new piece.
